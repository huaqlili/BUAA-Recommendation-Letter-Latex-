...
\def\Where{\hspace{-1.2mm}\textbf{\color[RGB]{0, 0, 139}%{shublue}
		Beihang University
}} 
...
\def\Address{No. 37 Xueyuan Road, Haidian District, Beijing
} 
%
%\def\CityZip{Haidian District, Beijing 100190 \\
	%P.R.China} 
%
% Set your e-mail here
\def\Email{\textbf{\color[RGB]{0, 0, 139}Post}: 100191}
%
% Set your preferred contact number here
\def\TEL{\textbf{\color[RGB]{0, 0, 139}Tel/Fax}: +86 10-82317114}
%
% Set your department or personal website here
%\def\URL{\textbf{\color{thutheme}Phone}: +86-15810847817}
%
...
\def\school{\small{
		SHU $\cdot$
		~Department of Mathematics $\cdot$
		~99, Shangda Road  $\cdot$
		~Shanghai, China P.R} } 
...
\begin{document}
   ...
   %Also, you can use this
	...
	% 	}
 \begin{letter}{To who it may concern, }
		...
		\node[text width=5.5cm] at (page cs:0.5,0.73){\small \newaddress};
		\end{tikzpicture} 
		
		%%%%%%  The ``opening'' is just the method of address you would like to use at the start of the letter.
		%
        % \vspace{-3mm}
        % \textbf{Letter of Support for Ms. LI Huaqiu – HKPFS Application}\\
        % \vspace{3mm}
        
            \opening{ }
    First paragraph (for overall recommendation and background):
    As [Your Title] at [Institution], I have had the privilege of supervising [Student's Name] for [duration]. I wholeheartedly recommend them for your [Program] due to their exceptional dedication and intellectual curiosity. Over [time], they have consistently demonstrated outstanding academic performance and a strong commitment to research, making them one of the most promising students I have encountered.
    
    Second paragraph (for academic achievements and research potential):
    [Student's Name] has achieved a GPA of [X] and published [number] papers in top-tier conferences, including [example]. Their work on [specific project] earned them the [award], highlighting their innovative thinking and technical proficiency. With their resilience under pressure and collaborative spirit, I am confident they will excel in your program and contribute significantly to your academic community.
